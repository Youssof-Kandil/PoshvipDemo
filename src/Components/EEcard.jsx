...
export default function EEcard({ backgroundImage, imageSrc, day, name, location }) {
  return (
    <>
      <div className="col-xxl-3 col-xl-4  col-md-4 col-sm-6 col-xs-12" style={{ height: '410px' }}>
        ...
        >
          ...
          <img src={imageSrc} alt="" className='img-fluid rounded-circle position-absolute' style={{ width: '44px', height: '44px', transition: 'transform 0.2s ease-in-out' }} />
