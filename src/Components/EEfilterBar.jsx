...
export default function EEfilterBar() {
  const handleMouseOver = (e) => {
    ...
    e.currentTarget.style.transition = 'color 0.2s ease-in-out, border-color 0.3s ease-in-out';
  };
  ...
  return (
    <>
      <div className=" pt-3 px-4 justify-content-center align-items-center row desktop ">
        ...
        <div className="col-3 col-md-2 ps-4 ">
          <button
            ...
            onMouseOver={(e)=>e.currentTarget.style.backgroundColor = '#03b2cb'}
            onMouseOut={  (e)=>  e.currentTarget.style.backgroundColor = '#151618'}
        ...
        <div className="d-flex justify-content-start align-items-center pe-5 col-9 col-md-10 text-white filter-input" >
         ...
         <h4 className='me-4 pb-1' style={{
          ...
          onMouseOver={handleMouseOver}
            onMouseOut={handleMouseOut}
          >This Week</h4>
          <p className='me-4 ' style={{fontWeight:'lighter'}}>in</p>
